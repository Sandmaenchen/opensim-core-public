...
git -C ~/opensim-workspace/opensim-core-source pull || git clone https://github.com/Sandmaenchen/opensim-core-public.git ~/opensim-workspace/opensim-core-source
